...
<div class="w3-sidebar w3-bar-block w3-light-grey" style="width:50%">
  ...
  <a href="" class="w3-bar-item w3-button">HOSTEL DETAILS</a>
  <a href="" class="w3-bar-item w3-button">HOSTEL MANAGEMENT</a>
  <a href="" class="w3-bar-item w3-button">ROOM DETAILS</a>
  
  <a href="#" class="w3-bar-item w3-button">MESSAGES</a>
  <a href="" class="w3-bar-item w3-button">APLICANTS</a>
  <a href=" class="w3-bar-item w3-button">ACCESS LOGIN</a>
